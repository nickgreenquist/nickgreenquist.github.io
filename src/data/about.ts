...
export const journey: JourneyStep[] = [
  ...
  },
  {
    ...
    title: "Rochester Institute of Technology (BS)",
    blurb: `BS in Game Design &amp; Development, CS minor. Wrestled four years for the <a href="https://ritathletics.com/sports/wrestling" target="_blank" rel="noopener noreferrer">NCAA D3 program</a> where I was team captain and a 3× Academic All-American.`,
  },
  {
    years: "2015 – 2018",
    icon: "💻",
    title: "Four SWE Internships",
    blurb: `Frontend, backend, and data engineering at <a href="http://ehealthtechnologies.com" target="_blank" rel="noopener noreferrer">eHealth Technologies</a>, <a href="http://geekhive.com/" target="_blank" rel="noopener noreferrer">GeekHive</a>, <a href="https://www.enigma.com/" target="_blank" rel="noopener noreferrer">Enigma</a>, and <a href="https://www.bluecore.com/" target="_blank" rel="noopener noreferrer">Bluecore</a>.`,
  },
  {
    years: "2017 – 2019",
    logo: nyuLogo,
    href: "https://www.nyu.edu/",
    title: "New York University, Courant (MS)",
  ...
  },
  {
    ...
    title: "Google",
    blurb: `Joined the <a href="https://play.google.com/store/games" target="_blank" rel="noopener noreferrer">Google Play Personalization</a> team out of grad school; now a Senior SWE building Play Store recommendation systems for billions of users.`,
  },
  {
    years: "2025 – forever",
    icon: "👶",
